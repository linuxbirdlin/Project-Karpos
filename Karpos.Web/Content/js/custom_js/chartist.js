...
// We are setting a few options for our chart and override the defaults
    ...
    var chart1 = new Chartist.Line('.ct-chart6', data6, options6);
    // line chart ends
...
// bar chart ends
    ...
    new Chartist.Line('.ct-chart2', data2, options2, responsiveoptions2);
   ...
   // Responsive function on parent div resize
    $('.ct-perfect-fourth').closest('.panel-body').on('resize', function () {
        ...
        new Chartist.Bar('.ct-chart1', data1, options1, responsiveOptions1);
        new Chartist.Line('.ct-chart2', data2, options2, responsiveoptions2);
        new Chartist.Line('.ct-chart3', data3, options3);
        new Chartist.Line('.ct-chart4', data4, options4);
        new Chartist.Line('.ct-chart5', data5, options5);
